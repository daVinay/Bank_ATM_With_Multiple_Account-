 ...
 * @author yours
 */
public class NetSaver extends Account implements IntrestAccount{

    NetSaver(){         //balance initialised
        balance = 1000;
    }
    ...
    boolean deposit(double b) {     //deposit function
       ...
       JOptionPane.showMessageDialog(null, "Your new net-saver account balance after deposit is: "+balance);
       return true;
    }
    ...
    boolean withdrawMoney(double b) {       //withdraw money function
        ...
        if(withdrawingAmount > balance )        //withdrawing money can't be more than balance
        {
            ...
            balance -=  withdrawingAmount; //set the new balance after withdrawal
             JOptionPane.showMessageDialog(null, "Your new balance after withdrawal is: "+balance);  
        }
         return true;
    ...
    public boolean intrestCal(double b) {    //calculates intrest
        ...
        double intrestRate = 3.5;  //higher intrest than saving account
        double intrestCharged = (3.5/100*balance)/12;  //divided by 12 so its calculated monthly
        ...
        JOptionPane.showMessageDialog(null, "Your new net-saver account balance is "+balance);
        return true;
    }
    ...
    boolean showStats() {       //main function of this account
        ...
        while (!userChoice){        //loop to show the menu
            ...
            userInput = JOptionPane.showInputDialog(frame, "This is your Net-Saver Account. \n"    //show user options
                    + "\nPlease choose from below options\n"
                    + "1). Withdraw\n"
                    + "2). Deposit\n"
                    + "3). Balance Inquiry\n"
                    + "4). Intrest\n"
                    + "5). Return to the main menu\n", "Net-saver Account", JOptionPane.PLAIN_MESSAGE);
                ...
                if(UInput == 1){     //If choice is 1, will withdraw
                   withdrawMoney(balance);
                    ...
                    JOptionPane.showMessageDialog(null, "Your net-saver account account balance is: "+balance);
                }
